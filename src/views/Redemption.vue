    ...
    <h-card class="purchase-card">
      <h-form :model="purchaseForm" class="purchase-form" @submit.prevent="submitForm">
        <h-row :gutter="290">
          ...
          <h-col :span="12">
            <h-form-item class="form-item-inline">
                ...
                <h-input 
                    v-model="purchaseForm.fundCode" 
                    placeholder="请输入基金代码" 
                    @blur="fetchFundDetails" 
        ...
        <h-row :gutter="290">
          <!-- 第二行 -->
            ...
            <h-form-item class="form-item-inline">
                ...
                <h-input v-model="purchaseForm.amount" placeholder="请输入赎回份额" type="number" :class="{ 'input-error': errors.amount }"></h-input>
        ...
        <h-form-item class="submit-button">
          <h-button type="primary" @mousedown="handleMouseDown" @mouseup="handleMouseUp" @click="submitForm" class="purchase-button">赎回</h-button>
        </h-form-item>
      </h-form>
    </h-card>
  </div>
